...
@Service
public class AnonymousTaskListFromWorkplan implements AbstractListService<Anonymous, Task> {
	...
	public Collection<Task> findMany(final Request<Task> request) {
		...
		int id;
		id=request.getModel().getInteger("id");
		result = this.repository.findPublicNotFinishedTasksFromWorkplan(id);
		final int a=12;
		return result;
	}
