...
/*
 * ManagerUserAccountCreateService.java
 *
...
@Service
public class ManagerUserAccountCreateService implements AbstractCreateService<Manager, UserAccount> {
	...
	public void validate(final Request<UserAccount> request, final UserAccount entity, final Errors errors) {
		...
		errors.state(request, !isDuplicated, "username", "manager.user-account.error.duplicated");
		...
		errors.state(request, isAccepted, "accept", "manager.user-account.error.must-accept");
		...
		errors.state(request, isMatching, "confirmation", "manager.user-account.error.confirmation-no-match");
	}
